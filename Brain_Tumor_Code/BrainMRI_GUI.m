...
h = waitbar(0,'Please wait applying ANN...');
steps = 1000;
for step = 1:steps
...
axes(handles.axes3)
imshow(img);title('Tumor Part Image');
...
figure,imshow(thin);
title('Morphological thinning Image');

grayImg1=segmentImage(EnImg);
axes(handles.axes2)
imshow(grayImg1);title('Segmented Part');
